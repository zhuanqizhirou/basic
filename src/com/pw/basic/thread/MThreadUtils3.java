...
public class MThreadUtils3 {
	...
	public static void countThread() {
		...
		// System.err.println(Thread.getAllStackTraces().size());
		System.err.println("方法1-----------");
		System.err.println("Threads size is " + atualThreads.length);
		for (Thread thread : atualThreads) {
			System.err.println("Thread name : " + thread.getName());
		}
